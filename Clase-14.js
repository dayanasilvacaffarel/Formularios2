...
function botonCerrarSesion() {
    ...
    buttonCerrarSesion.style= "padding: 5px 20px; background:rgba(255,0,0,0.2);color: red; margin: 20px; border-style: none; cursor: pointer;";
    buttonCerrarSesion.innerHTML+=`<p>Cerrar sesión</p>`;

    divUser.appendChild(buttonCerrarSesion);

    document.addEventListener('click', function(){

        const cerrarSesion = confirm("¿Seguro desea cerrar sesión?");
